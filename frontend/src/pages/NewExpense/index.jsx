...
export default function NewExpense() {
  ...
  const handleSubmit = (e) => {
    e.preventDefault()
    if (!formData.name)
      return alert('Por favor, informe o nome da despesa')
    ...
    <div className="ne-root">
      ...
      <div className="ne-shell">
        <header className="ne-header">
          <button className="ne-header__back" type="button" onClick={() => navigate('/dashboard')} aria-label="Voltar">
        ...
        <form className="ne-form" onSubmit={handleSubmit} noValidate>
          ...
          <div className="ne-group">
            ...
            <input id="ne-name" className="ne-input" type="text" placeholder="Ex: Conta de Luz"
          ...
          <div className="ne-group">
            ...
            <div className="ne-price-wrap">
              <input id="ne-price" className="ne-price-input" type="text" inputMode="numeric"
          ...
          <div className="ne-group">
            ...
            <textarea id="ne-notes" className="ne-textarea" rows={3}
