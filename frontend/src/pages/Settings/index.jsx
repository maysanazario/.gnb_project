...
export default function Settings() {
  ...
  const menuItems = [
    { label: 'Editar perfil',  icon: 'user',   action: () => {},       danger: false },
    { label: 'Notificações',   icon: 'bell',   action: () => {},       danger: false },
    { label: 'Privacidade',    icon: 'shield', action: () => {},       danger: false },
    { label: 'Termos de uso',  icon: 'file',   action: () => {},       danger: false },
    ...
    <div className="st-root">
      ...
      <div className="st-shell">
        <header className="st-header">
          <button className="st-header__back" onClick={() => navigate('/dashboard')} aria-label="Voltar">
        ...
        <div className="st-profile">
          <div className="st-profile__avatar"><span>J</span></div>
