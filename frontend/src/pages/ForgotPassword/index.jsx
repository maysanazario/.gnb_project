  ...
  return (
    <div className="fp-screen">
      ...
      <div className="fp-card">
        <button className="fp-back" onClick={() => navigate('/login')} aria-label="Voltar para login">
        ...
        {!sent ? (
          <form onSubmit={handleSubmit}>
            ...
            <div className={`fp-input-wrap${emailError ? ' fp-error' : ''}`}>
              ...
              />
              {emailError && <span className="fp-error-message">⚠️ {emailError}</span>}
            </div>
          ...
          <div className="fp-success">
            ...
            <h2 className="fp-success__title">E-mail enviado!</h2>
            <p className="fp-success__text">
              Verifique sua caixa de entrada e siga as instruções para redefinir sua senha.
            </p>
            <button className="fp-btn fp-btn--secondary" onClick={() => navigate('/login')}>
              Voltar para o login
            </button>
          </div>
        )}
