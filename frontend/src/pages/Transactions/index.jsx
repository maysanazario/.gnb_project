    ...
    <div className="tx-root">
      ...
      <div className="tx-shell">
        <header className="tx-header">
          <button className="tx-header__back" onClick={() => navigate('/dashboard')} aria-label="Voltar">
        ...
        <section className="tx-section">
          ...
          <div className="tx-list-card">
            {MOCK_EXPENSES.map((expense, idx) => (
              <button key={expense.id} className="tx-item" onClick={() => {}}>
                <div className="tx-item__left">
                  <span className="tx-item__icon">{getExpenseIcon(expense.icon)}</span>
                ...
                <div className="tx-item__right">
                  ...
                  <span className="tx-item__arrow"><IconChevronRight /></span>
                </div>
                {idx < MOCK_EXPENSES.length - 1 && <div className="tx-item-divider" />}
              </button>
            ))}
          </div>
        </section>
