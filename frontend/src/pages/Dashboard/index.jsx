      ...
      <div className="db-shell">
        ...
        <header className="db-header">
          <div className="db-header__user">
            ...
            <div className="db-header__greeting">
              <span className="db-header__hello">Olá, Juninho 👋</span>
        ...
        <section className="db-balance">
          ...
          <div className="db-balance__variation">
            <span className="db-balance__trend-icon"><IconTrendUp /></span>
        ...
        <section className="db-section">
          ...
          <div className="db-summary-card">
            <button className="db-summary-row" onClick={() => navigate('/reports')}>
              <div className="db-summary-row__left">
                <span className="db-summary-row__icon db-summary-row__icon--income"><IconChart /></span>
              ...
              <span className="db-summary-row__arrow"><IconChevronRight /></span>
            </button>
            <div className="db-summary-divider" />
            <button className="db-summary-row" onClick={() => navigate('/reports')}>
              <div className="db-summary-row__left">
                <span className="db-summary-row__icon db-summary-row__icon--expense"><IconArrowDown /></span>
                <div className="db-summary-row__info">
            ...
            <button className="db-summary-row" onClick={() => navigate('/reports')}>
              <div className="db-summary-row__left">
                <span className="db-summary-row__icon db-summary-row__icon--balance"><IconWallet /></span>
                <div className="db-summary-row__info">
        ...
        <section className="db-section">
          ...
          <div className="db-expenses-card">
            {MOCK_EXPENSES.slice(0, 3).map((expense, idx) => (
              <button key={expense.id} className="db-expense-row" onClick={() => navigate('/transactions')}>
                <div className="db-expense-row__left">
                  <span className="db-expense-row__icon">{getExpenseIcon(expense.icon)}</span>
                  <div className="db-expense-row__info">
                    <span className="db-expense-row__name">{expense.name}</span>
                    <span className="db-expense-row__amount">{formatCurrency(expense.amount)}</span>
                  </div>
                </div>
                <span className="db-expense-row__arrow"><IconChevronRight /></span>
                {idx < 2 && <div className="db-expense-divider" />}
              </button>
            ))}
          </div>
        </section>
