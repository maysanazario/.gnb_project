...
export default function Login() {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!isPasswordValid) { setPasswordError('Senha obrigatória'); return }
    ...
    try {
      ...
      if (!response.ok) {
        setApiError(data?.message || 'E-mail ou senha inválidos')
        return
      }
      ...
      <div className="card">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className={`input-wrap input-pass${passwordError ? ' error' : ''}`}>
            ...
            {passwordError && <span className="error-message">⚠️ {passwordError}</span>}
          </div>
